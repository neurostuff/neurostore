...
2. **Base Study Datatype Filtering**: `curl "http://localhost/api/base-studies?data_type=coordinate"` -- should return ingested coordinate studies after `manage ingest-neurosynth --max-rows 100`
