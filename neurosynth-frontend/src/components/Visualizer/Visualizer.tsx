...
const Visualizer: React.FC<VisualizerModel> = (props) => {
    const classes = VisualizerStyles();
    ...
    useEffect(() => {
        ...
        (window as any).papaya.Container.startPapaya();

        (window as any).papaya.Container.resetViewer(props.index, params);
    }, [props.fileName, props.imageURL, props.overlayURL, props.index]);
