...
def upgrade():
    ...
    op.drop_constraint("analyses_study_id_fkey", "analyses", type_="foreignkey")
    op.create_foreign_key(
        "analyses_study_id_fkey",
        "analyses",
        "studies",
        ["study_id"],
        ["id"],
    ...
    op.drop_constraint("points_analysis_id_fkey", "points", type_="foreignkey")
    op.create_foreign_key(
        "points_analysis_id_fkey",
        "points",
        "analyses",
        ["analysis_id"],
        ["id"],
    ...
    op.drop_constraint("entities_study_id_fkey", "entities", type_="foreignkey")
    op.create_foreign_key(
        "entities_study_id_fkey",
        "entities",
        "studies",
        ["study_id"],
        ["id"],
    ...
    op.drop_constraint("point_entities_entity_fkey", "point_entities", type_="foreignkey")
    op.create_foreign_key(
        "point_entities_entity_fkey",
        "point_entities",
        "entities",
        ["entity"],
        ["id"],
    ...
    op.drop_constraint("point_entities_point_fkey", "point_entities", type_="foreignkey")
    op.create_foreign_key(
        "point_entities_point_fkey",
        "point_entities",
        "points",
        ["point"],
        ["id"],
    ...
    op.drop_constraint("image_entities_entity_fkey", "image_entities", type_="foreignkey")
    op.create_foreign_key(
        "image_entities_entity_fkey",
        "image_entities",
        "entities",
        ["entity"],
        ["id"],
    ...
    op.drop_constraint("image_entities_image_fkey", "image_entities", type_="foreignkey")
    op.create_foreign_key(
        "image_entities_image_fkey",
        "image_entities",
        "images",
        ["image"],
        ["id"],
    ...
    op.create_index(
        op.f("ix_analyses_study_id"), "analyses", ["study_id"], unique=False
    )
    op.create_index(
        op.f("ix_analyses_updated_at"), "analyses", ["updated_at"], unique=False
    )
    op.create_index(op.f("ix_analyses_user_id"), "analyses", ["user_id"], unique=False)
    op.drop_constraint(
        "analysis_conditions_analysis_id_fkey",
        "analysis_conditions",
        type_="foreignkey",
    )
    op.drop_constraint(
        "analysis_conditions_condition_id_fkey",
        "analysis_conditions",
        type_="foreignkey",
    )
    op.create_foreign_key(
    ...
    op.create_index(
        op.f("ix_annotation_analyses_created_at"),
        "annotation_analyses",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_annotation_analyses_updated_at"),
        "annotation_analyses",
        ["updated_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_annotation_analyses_user_id"),
        "annotation_analyses",
        ["user_id"],
        unique=False,
    )
    op.drop_constraint(
        "annotation_analyses_analysis_id_fkey",
        "annotation_analyses",
        type_="foreignkey",
    )
    op.drop_constraint(
        "annotation_analyses_annotation_id_fkey",
        "annotation_analyses",
        type_="foreignkey",
    )
    op.create_foreign_key(
    ...
    op.create_foreign_key(
        None, "annotation_analyses", "users", ["user_id"], ["external_id"]
    )
    op.create_index(
        op.f("ix_annotations_created_at"), "annotations", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_annotations_studyset_id"), "annotations", ["studyset_id"], unique=False
    )
    op.create_index(
    ...
    op.drop_constraint(
        "annotations_studyset_id_fkey", "annotations", type_="foreignkey"
    )
    op.create_foreign_key(
        None, "annotations", "studysets", ["studyset_id"], ["id"], ondelete="CASCADE"
    )
    op.add_column("base_studies", sa.Column("pmcid", sa.String(), nullable=True))
    op.create_index(
        op.f("ix_base_studies_created_at"), "base_studies", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_base_studies_pmcid"), "base_studies", ["pmcid"], unique=False
    )
    op.create_index(
        op.f("ix_base_studies_updated_at"), "base_studies", ["updated_at"], unique=False
    )
    op.create_index(
        op.f("ix_conditions_created_at"), "conditions", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_conditions_updated_at"), "conditions", ["updated_at"], unique=False
    )
    op.create_index(
        op.f("ix_conditions_user_id"), "conditions", ["user_id"], unique=False
    )
    op.create_index(
        op.f("ix_entities_analysis_id"), "entities", ["analysis_id"], unique=False
    )
    op.create_index(
        op.f("ix_entities_created_at"), "entities", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_entities_updated_at"), "entities", ["updated_at"], unique=False
    )
    op.create_index(
        op.f("ix_image_entities_entity"), "image_entities", ["entity"], unique=False
    )
    op.create_index(
        op.f("ix_image_entities_image"), "image_entities", ["image"], unique=False
    )
    op.create_index(
        op.f("ix_images_analysis_id"), "images", ["analysis_id"], unique=False
    )
    op.create_index(
        op.f("ix_images_created_at"), "images", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_images_updated_at"), "images", ["updated_at"], unique=False
    )
    op.create_index(op.f("ix_images_user_id"), "images", ["user_id"], unique=False)
    op.create_index(
        op.f("ix_point_entities_entity"), "point_entities", ["entity"], unique=False
    )
    op.create_index(
        op.f("ix_point_entities_point"), "point_entities", ["point"], unique=False
    )
    op.create_index(
        op.f("ix_point_values_created_at"), "point_values", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_point_values_point_id"), "point_values", ["point_id"], unique=False
    )
    op.create_index(
        op.f("ix_point_values_updated_at"), "point_values", ["updated_at"], unique=False
    )
    op.create_index(
        op.f("ix_point_values_user_id"), "point_values", ["user_id"], unique=False
    )
    op.create_index(
        op.f("ix_points_analysis_id"), "points", ["analysis_id"], unique=False
    )
    op.create_index(
        op.f("ix_points_created_at"), "points", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_points_updated_at"), "points", ["updated_at"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_studies_base_study_id"), "studies", ["base_study_id"], unique=False
    )
    op.create_index(
        op.f("ix_studies_created_at"), "studies", ["created_at"], unique=False
    )
    op.create_index(op.f("ix_studies_pmcid"), "studies", ["pmcid"], unique=False)
    op.create_index(
        op.f("ix_studies_updated_at"), "studies", ["updated_at"], unique=False
    )
    op.create_index(
        op.f("ix_studysets_created_at"), "studysets", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_studysets_updated_at"), "studysets", ["updated_at"], unique=False
    )
    op.create_index(
        op.f("ix_studysets_user_id"), "studysets", ["user_id"], unique=False
    )
...
def downgrade():
    ...
    op.add_column(
        ...
        sa.Column(
            ...
            postgresql.TSVECTOR(),
            sa.Computed(
                "to_tsvector('english'::regconfig, (((COALESCE(name, ''::character varying))::text || ' '::text) || (COALESCE(description, ''::character varying))::text))",
                persisted=True,
            ),
            autoincrement=False,
            nullable=True,
    ...
    op.drop_index(
        op.f("ix_annotation_analyses_user_id"), table_name="annotation_analyses"
    )
    op.drop_index(
        op.f("ix_annotation_analyses_updated_at"), table_name="annotation_analyses"
    )
    op.drop_index(
        op.f("ix_annotation_analyses_created_at"), table_name="annotation_analyses"
    )
