...
status_enum = PGEnum(
    "SUCCESS", "FAILURE", "ERROR", "UNKNOWN", name="status_enum", create_type=False
)
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "embedding", neurostore.models.migration_types.VectorType(), nullable=False
        ),
    ...
    with op.batch_alter_table("pipeline_embeddings", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_pipeline_embeddings_base_study_id"),
            ["base_study_id"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_pipeline_embeddings_config_id"), ["config_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_pipeline_embeddings_created_at"),
            ["created_at"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_pipeline_embeddings_updated_at"),
            ["updated_at"],
            unique=False,
        )
