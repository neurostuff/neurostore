...
Revision ID: 33f314fb6151
Revises: 2dd9d658d753
Create Date: 2026-01-21 22:44:23.129959
...
revision = '33f314fb6151'
down_revision = '2dd9d658d753'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.CheckConstraint('id != superseded_by', name='no_self_reference'),
    sa.ForeignKeyConstraint(['superseded_by'], ['base_studies.id'], ),
    ...
    with op.batch_alter_table('base_studies', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_base_studies_is_active'), ['is_active'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('base_studies', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_base_studies_is_active'))
