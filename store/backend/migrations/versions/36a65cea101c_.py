...
def upgrade():
    ...
    studies_columns = (
        {col["name"] for col in inspector.get_columns("studies")}
    ...
    analyses_columns = (
        {col["name"] for col in inspector.get_columns("analyses")}
    ...
    images_columns = (
        {col["name"] for col in inspector.get_columns("images")}
    ...
    points_columns = (
        {col["name"] for col in inspector.get_columns("points")}
        if inspector.has_table("points")
        else set()
    )
    ...
    entities_columns = (
        {col["name"] for col in inspector.get_columns("entities")}
    ...
    if "analysis_id" not in entities_columns and inspector.has_table("entities"):
        ...
        op.create_foreign_key(
            None, "entities", "analyses", ["analysis_id"], ["id"], ondelete="CASCADE"
        )

    point_values_columns = (
        {col["name"] for col in inspector.get_columns("point_values")}
        if inspector.has_table("point_values")
        else set()
    )
    ...
    tables = {
        "studies": lambda: op.create_table(
            "studies",
            sa.Column("id", sa.Text(), nullable=False),
            sa.Column(
                "created_at",
        ...
        "studysets": lambda: op.create_table(
            "studysets",
            sa.Column("id", sa.Text(), nullable=False),
            sa.Column(
                "created_at",
        ...
        "analyses": lambda: op.create_table(
            "analyses",
            sa.Column("id", sa.Text(), nullable=False),
            sa.Column(
                "created_at",
        ...
        "annotations": lambda: op.create_table(
            "annotations",
            sa.Column("id", sa.Text(), nullable=False),
            sa.Column(
                "created_at",
        ...
        "annotation_analyses": lambda: op.create_table(
            "annotation_analyses",
            sa.Column("study_id", sa.Text(), nullable=False),
            sa.Column("studyset_id", sa.Text(), nullable=False),
        ...
        "entities": lambda: op.create_table(
            "entities",
            sa.Column("id", sa.Text(), nullable=False),
            sa.Column(
                "created_at",
        ...
        "image_entities": lambda: op.create_table(
            "image_entities",
        ...
        "point_entities": lambda: op.create_table(
            "point_entities",
        ...
        "point_values": lambda: op.create_table(
            "point_values",
            sa.Column("id", sa.Text(), nullable=False),
            sa.Column(
                "created_at",
