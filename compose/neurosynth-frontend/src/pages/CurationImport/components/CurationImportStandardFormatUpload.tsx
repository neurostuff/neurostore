...
import { ENeurosynthSourceIds } from 'pages/Project/store/ProjectStore.types';
...
const CurationImportStandardFormatUpload: React.FC<{
...
export default CurationImportStandardFormatUpload;
