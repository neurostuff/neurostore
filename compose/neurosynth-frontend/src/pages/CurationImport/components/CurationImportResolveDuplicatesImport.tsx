...
import CurationImportResolveDuplicatesReadOnlyStubSummary from './CurationImportResolveDuplicatesReadOnlyStubSummary';
...
const CurationImportResolveDuplicatesImport: React.FC<{
                            ...
                            <AccordionDetails>
                                {duplicateList.map((stub, duplicateStubIndex) => (
                                    ...
                                    >
                                        ...
                                        >
                                            <Box sx={{ width: '100%' }}>
                                                <CurationImportResolveDuplicatesReadOnlyStubSummary
                                                    {...stub}
                                                />
                                            </Box>
                                        </Box>
...
export default CurationImportResolveDuplicatesImport;
