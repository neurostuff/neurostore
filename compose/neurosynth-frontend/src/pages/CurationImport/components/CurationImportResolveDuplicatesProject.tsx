...
} from 'pages/CurationImport/CurationImport.types';
import { flattenColumns } from 'pages/CurationImport/CurationImport.helpers';

const CurationImportResolveDuplicatesProject: React.FC<{
...
export default CurationImportResolveDuplicatesProject;
