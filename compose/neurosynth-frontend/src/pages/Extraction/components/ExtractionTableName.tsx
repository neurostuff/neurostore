...
export const ExtractionTableNameCell = (props: CellContext<IExtractionTableStudy, string>) => {
...
export const ExtractionTableNameHeader = ({ table, column }: HeaderContext<IExtractionTableStudy, string>) => {
    ...
    return (
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            {!isSorted ? (
                ...
                <IconButton size="small" onClick={() => table.setSorting([{ id: 'name', desc: false }])}>
