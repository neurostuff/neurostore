...
export const CuratorTableTitleCell: React.FC<CellContext<ICurationTableStudy, string>> = (props) => {
...
export const CuratorTableTitleHeader: React.FC<HeaderContext<ICurationTableStudy, string>> = ({ table, column }) => {
