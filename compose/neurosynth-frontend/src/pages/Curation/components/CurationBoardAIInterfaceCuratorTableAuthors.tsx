...
export const CuratorTableAuthorsCell: React.FC<CellContext<ICurationTableStudy, string>> = (props) => {
...
export const CuratorTableAuthorsHeader: React.FC<HeaderContext<ICurationTableStudy, string>> = ({ table, column }) => {
    ...
    return (
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            {!isSorted ? (
                <Tooltip title="Sort by Authors" placement="top">
                    <IconButton
                        size="small"
                        onClick={() => {
                            if (isSorted) {
