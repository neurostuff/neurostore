...
export const CuratorTableJournalCell: React.FC<CellContext<ICurationTableStudy, string>> = (props) => {
...
export const CuratorTableJournalHeader: React.FC<HeaderContext<ICurationTableStudy, string>> = ({ table, column }) => {
