...
import { useUpdateDBWithAnnotationFromStore } from 'stores/annotation/AnnotationStore.actions';
import { useAnnotationIsEdited, useAnnotationNotes } from 'stores/annotation/AnnotationStore.getters';
import {
    mockAnalyses,
    mockAnnotations,
    mockStorePoints,
