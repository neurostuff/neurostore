...
import { useStudyAnalysisPointSpace, useStudyAnalysisPointStatistic } from 'stores/study/StudyStore';
import { DefaultMapTypes, DefaultSpaceTypes, MapOrSpaceType } from 'stores/study/StudyStore.helpers';
...
const EditStudyAnalysisCBMAPointSpaceAndStatistic = (props: { analysisId?: string }) => {
