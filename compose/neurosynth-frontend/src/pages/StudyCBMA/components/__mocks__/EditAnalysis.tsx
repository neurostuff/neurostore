...
const MockEditAnalysis: React.FC<{ analysis: AnalysisReturn | undefined }> = (props) => {
    ...
    return (
        <div>
            ...
            <button data-testid="mock-edit-analysis-details" onClick={() => setTabIndex(0)}></button>
            <button data-testid="mock-edit-analysis-conditions" onClick={() => setTabIndex(1)}></button>
            <button data-testid="mock-edit-analysis-images" onClick={() => setTabIndex(2)}></button>
            <button data-testid="mock-edit-analysis-general" onClick={() => setTabIndex(3)}></button>
            <div>
