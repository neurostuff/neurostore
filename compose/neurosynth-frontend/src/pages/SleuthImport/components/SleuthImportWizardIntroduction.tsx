        ...
        <Box>
            <Box>
                ...
                <Typography gutterBottom my="1rem">
                    Once a sleuth file is uploaded in the next page, neurosynth compose will try and map the studies
                    within the sleuth file to existing studies.
                </Typography>
                <Typography gutterBottom my="1rem">
                    Neurosynth compose will treat each file uploaded as a separate meta-analysis. Upload multiple sleuth
                    files to create multiple runnable meta-analyses in neurosynth compose.
                </Typography>
                <Typography gutterBottom my="1rem">
                    The next step will guide you through the upload process. On the next page, click on the question
                    mark icon at the top of the page to see the correct, expected format for sleuth files.
                </Typography>
