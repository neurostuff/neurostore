...
import { NEUROSYNTH_COMPOSE_CITATION } from 'constants/citations';
            ...
            <Box sx={[LandingPageStyles.sectionContainer, { backgroundColor: 'primary.main' }]}>
                ...
                >
                    <Box sx={LandingPageStyles.heroBannerTextContainer}>
                        ...
                        <Box sx={LandingPageStyles.publicationBlurbContainer}>
                            <Typography
                                component="a"
                                ...
                                rel="noreferrer"
                                variant="h3"
                                sx={[LandingPageStyles.heroBannerText, LandingPageStyles.publicationBlurbLink]}
                            >
                                Read our recent publication in Imaging Neuroscience!
                            </Typography>
                        </Box>
                    </Box>
