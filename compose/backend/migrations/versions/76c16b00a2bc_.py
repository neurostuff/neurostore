...
def upgrade():
    ...
    tables = {
        "annotation_references": lambda: op.create_table(
            "annotation_references",
            sa.Column("id", sa.Text(), nullable=False),
            sa.PrimaryKeyConstraint("id"),
        ),
        "roles": lambda: op.create_table(
            "roles",
            sa.Column("id", sa.Text(), nullable=False),
            sa.Column(
                "created_at",
        ...
        "studyset_references": lambda: op.create_table(
            "studyset_references",
            sa.Column("id", sa.Text(), nullable=False),
            sa.PrimaryKeyConstraint("id"),
        ),
        "users": lambda: op.create_table(
            "users",
            sa.Column("id", sa.Text(), nullable=False),
            sa.Column(
                "created_at",
        ...
        "roles_users": lambda: op.create_table(
            "roles_users",
        ...
        "specifications": lambda: op.create_table(
            "specifications",
            sa.Column("id", sa.Text(), nullable=False),
            sa.Column(
                "created_at",
        ...
        "meta_analyses": lambda: op.create_table(
            "meta_analyses",
            sa.Column("id", sa.Text(), nullable=False),
            sa.Column(
                "created_at",
    ...
    studyset_cols = (
        set(col["name"] for col in inspector.get_columns("studysets"))
    ...
    annotation_cols = (
        set(col["name"] for col in inspector.get_columns("annotations"))
    ...
    if inspector.has_table("annotations"):
        if "snapshot" not in annotation_cols:
            op.add_column(
                "annotations", sa.Column("snapshot", sa.JSON(), nullable=True)
            )
