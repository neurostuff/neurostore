...
def upgrade():
    ...
    op.add_column(
        "specification_conditions", sa.Column("user_id", sa.Text(), nullable=True)
    )
    op.create_foreign_key(
        None, "specification_conditions", "users", ["user_id"], ["external_id"]
    )
    op.add_column(
        "specifications", sa.Column("database_studyset", sa.Text(), nullable=True)
    )
