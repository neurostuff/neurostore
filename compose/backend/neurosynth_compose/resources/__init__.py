from neurosynth_compose.resources.analysis import (
    ConditionsResource, NeurostoreAnnotationsView, NeurostoreStudysetsView,
    SnapshotAnnotationsView, SnapshotStudysetsView,
    SpecificationConditionsResource, SpecificationsView, TagsView)
...
from neurosynth_compose.resources.data_views import (  # noqa: F401
    ...
    NeurovaultCollectionsView, NeurovaultFilesView, ProjectsView,
